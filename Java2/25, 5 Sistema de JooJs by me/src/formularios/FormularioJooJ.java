...
public class FormularioJooJ extends JPanel {
	...
	private JTextField txtClassificação;
	...
	public FormularioJooJ() {
		...
		//Instanciar objeto da classe ação
		Ação a = new Ação();
		...
		txtClassificação = new JTextField();
		txtClassificação.setBounds(191, 152, 116, 27);
		txtClassificação.setFont(new Font("Comic Sans MS", Font.PLAIN, 14));
		add(txtClassificação);
		txtClassificação.setColumns(10);
		...
		btnCadastrarJogo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					j.setClassificação(Integer.parseInt(txtClassificação.getText()));
				...
				txtNome.setText("");
				txtValor.setText("");
				txtClassificação.setText("");
				cbxGenero.setSelectedIndex(0);
				cbxPlataforma.setSelectedIndex(0);
				
				//Ativar o botão de cadastramentio e desativar os demais
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				j.setClasssificacão(Integer.parseInt(txtClassificação.getText()));
				j.setValor(Double.parseDouble(txtValor.getText()));
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				txtClassificação.setText(String.valueOf(classificacao));
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				String genero = table.getValueAt(indice, 1).toString();
				String plataforma = table.getValueAt(indice, 2).toString();
				int classificação = Integer.parseInt(table.getValueAt(indice, 3).toString());
				double valor = Double.parseDouble(table.getValueAt(indice, 4).toString());
				...
				lblIndice.setText(String.valueOf(indice));
				txtNome.setText(nome);
				txtClassificação.setText(String.valueOf(classificação));
				txtValor.setText(String.valueOf(valor));
				...
				//Ativar botões de alterar e excluir e desatiar o botão cadastrar
