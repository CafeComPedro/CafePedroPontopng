...
int[] numeros = new int[15];
		...
		JOptionPane.showMessageDialog(null, "Números iguais que a média: \n"+NumerosMedia+"\n");
		JOptionPane.showMessageDialog(null, "Números maiores a média: \n"+MaiorMedia+"\n");
		...
		JOptionPane.showMessageDialog(null, "Números impares: \n"+impar);
}
}
